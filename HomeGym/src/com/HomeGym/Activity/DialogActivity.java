...
public class DialogActivity extends Activity  {
 		...
 		wakeLock.acquire(); 
	       ...
	       AlertDialog.Builder alert_confirm = new AlertDialog.Builder(new ContextThemeWrapper(this, android.R.style.Theme_Holo_Light_Dialog ));
	        ...
	        new DialogInterface.OnClickListener() {
	            ...
	            public void onClick(DialogInterface dialog, int which) {
	                // 'No'
	            	Toast toast = Toast.makeText(DialogActivity.this, "메렁", Toast.LENGTH_SHORT ); 
	            	   toast.show();
	            	   alert.show();
	...
	protected void onStart(){
		...
		if(km == null){
        	...
        	km		= (KeyguardManager)getSystemService(Activity.KEYGUARD_SERVICE);//Context.KEYGUARD_SERVICE
